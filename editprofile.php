...
<option value="MPHIL" <?php if($row['education']=='MPHIL'){ ?>selected="selected" <?php }?>>MPHIL</option>
						...
						<div class="col-md-3">
							<select class="form-control" name="designation" required="required">
											...
											<option value="Intern" <?php if($row['designation']=='Intern'){ ?>selected="selected" <?php }?>>Phase 1</option>
											<option value="Jr. Recruiter" <?php if($row['designation']=='Jr. Recruiter'){ ?>selected="selected" <?php }?>>Phase 2</option>
											<option value="Recruiter" <?php if($row['designation']=='Recruiter'){ ?>selected="selected" <?php }?>>Phase3</option>
									</select>
						</div>
						<div class="col-md-3">
							<b>Reporting To</b>
